...
import { AlertVariants, BooleanArg } from 'hex/-private/types';
...
export default class Alert extends Component<AlertArgs> {
  @tracked('args')
  get variant(): AlertVariants {
    return this.args.variant ||
      this.checkFlag('success') ||
      this.checkFlag('danger') ||
      this.checkFlag('info') ||
      'info';
  }
  ...
  private checkFlag(key: AlertVariants): AlertVariants | false {
